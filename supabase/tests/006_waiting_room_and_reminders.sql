...
begin
  ...
  insert into public.guardians (id, full_name, phone) values (v_guardian, 'Acudiente reminder', '+573107777771');
  insert into public.students (id, guardian_id, full_name) values (v_student, v_guardian, 'Estudiante reminder');
  insert into public.guardian_cycle_invitations (guardian_id, cycle_id, token_hash) values (v_guardian, v_cycle, v_hash);
