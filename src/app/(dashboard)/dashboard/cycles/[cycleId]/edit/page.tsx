...
export const metadata = { title: "Editar ciclo" };

export default async function EditCyclePage({ params }: Readonly<{ params: Promise<{ cycleId: string }> }>) {
  ...
  return <CycleDetail cycle={detail} mode="edit" />;
}
